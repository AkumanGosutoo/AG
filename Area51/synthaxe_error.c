...
** Last update Sat Jan  3 16:51:17 2015 kamel lahmar
*/
...
char	*get_name(char *str)
{
  ...
  return (my_name);
   ...
   /* int	get_params(char *str, char *tab[3]) */
    /* { */
  
    /* } */

    /* int	synthaxe_error_2(char *str) */
    /* { */
    /*   char	*(tab[3]); */
    /*   int	i; */
    /*   int	n; */

    /*   i = malloc(sizeof(char*)str); */
    /*   n = 0; */
    /*   while (str[i] != ';') */
    /*     { */
    /*       while (str[i] == '*') */
    /* 	tab[0][n++] = str[i++]; */
    /*       if (my_char_is_alpha(str[i]) || str[i] == ' ' && str[i] != ';') */
    /* 	{ */
    /* 	  while (my_char_is_alpha_num(str[i]) || str[i] == ' ' && str[i] != ';') */
    /* 	    tab[0][n++] = str[i++]; */
    /* 	} */
    /*       /\* if (str[i] == '(') *\/ */
    /*       /\* 	{ *\/ */
    /*       /\* 	  i = i + get_params(str, tab[1]); *\/ */
    /*       /\* 	  i = i + get_params(str, tab[2]); *\/ */
    /*       /\* 	} *\/ */
    /*     } */
    /*   return (0); */
    /* } */
